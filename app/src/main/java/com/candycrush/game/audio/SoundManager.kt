package com.candycrush.game.audio
...
class SoundManager(private val context: Context) {
    ...
    /**
     * Play the swap sound when two candies are exchanged.
     */
    fun playSwap() {
    ...
    /**
     * Play the cascade/gravity sound when candies fall down.
     *
    ...
    /**
     * Play the special candy activation sound (striped, wrapped, color bomb).
     */

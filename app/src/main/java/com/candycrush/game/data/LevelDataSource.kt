...
object LevelDataSource {
    ...
    val levels: List<LevelConfig> = listOf(
        ...
        LevelConfig(
            ...
            threeStarScore = 8000,
            availableCandyTypes = 5,
            description = "Break the ice to clear candies!",
            obstacles = mapOf(
        ...
        // Level 11: First ClearCandyType objective! Clear 25 red candies.
        ...
        LevelConfig(
            ...
            availableCandyTypes = 5,
            description = "Clear 25 red candies!",
            objective = ObjectiveType.ClearCandyType(CandyType.Red, targetCount = 25)
        ),
        ...
        // Level 13: ClearCandyType objective with 6 colors — clear 30 blue candies.
        // Harder because more colors means fewer blue candies appear naturally.
        LevelConfig(
            levelNumber = 13,
            rows = 8, cols = 8,
            maxMoves = 16,
            ...
            description = "Clear 30 blue candies!",
            objective = ObjectiveType.ClearCandyType(CandyType.Blue, targetCount = 30)
        ),
        ...
        // ClearCandyType objective — clear 40 green candies through the obstacle maze!
        LevelConfig(
            levelNumber = 20,
            rows = 9, cols = 9,
            maxMoves = 12,
            ...
            availableCandyTypes = 6,
            description = "Clear 40 green candies!",
            objective = ObjectiveType.ClearCandyType(CandyType.Green, targetCount = 40),
            obstacles = mapOf(

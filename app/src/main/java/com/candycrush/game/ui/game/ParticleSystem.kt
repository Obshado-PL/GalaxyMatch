...
import com.candycrush.game.model.Particle
 ...
 *
 * The particle system:
 * 1. Spawns bursts of particles at candy positions when they're cleared
...
class ParticleSystem {
     ...
     * @param color The candy's color — particles inherit it
     ...
     * @param isSpecial Whether the cleared candy was a special type
     */
     ...
     *
     * Used when a candy with ice overlay is cleared. The particles are shorter-lived
    ...
    fun spawnIceShatter(x: Float, y: Float, count: Int = 12, speed: Float = 250f) {
        ...
        for (i in 0 until actualCount) {
            ...
            // Shorter-lived than candy particles — ice shatters quickly
    ...
    /**
     * Spawn a directional line burst for striped candy activations.
     *
    ...
    /**
     * Spawn an expanding ring burst for wrapped candy activations.
     *
     ...
     *
     * Uses all 6 candy colors to create a spectacular chromatic explosion.

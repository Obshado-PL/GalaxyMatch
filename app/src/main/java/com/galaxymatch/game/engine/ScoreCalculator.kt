 ...
 * - Each extra gem beyond 3 adds 50 bonus points
...
class ScoreCalculator {
    ...
    fun calculateMatchScore(matchResult: MatchResult, comboLevel: Int): Int {
        ...
        val baseScore = when {
            ...
            matchResult.matchLength == 4 -> 200   // Striped gem match
            else -> 100                           // Regular match of 3
        }

        // Bonus for extra gems beyond the minimum 3
        val extraGemBonus = maxOf(0, matchResult.positions.size - 3) * 50
        ...
        return ((baseScore + extraGemBonus) * comboMultiplier).toInt()
    }
